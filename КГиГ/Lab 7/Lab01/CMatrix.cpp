...
// j - номер столбца
{
	if ((i > n_rows - 1) || (j > n_cols - 1))     //  проверка выхода за диапазон индексации массива.
	{
...
// i - номер строки для вектора
{
	...
	if (i > n_rows - 1)     //  проверка выхода за диапазон индексации массива.
	{
...
{
	bool b1 = (k >= 0) && (k < n_cols);
	bool b2 = (n >= 0) && (n <= m);
	bool b3 = (m >= 0) && (m < n_rows);
	bool b4 = b1 && b2 && b3;
	if (!b4)
	{
