...
namespace laba_2
{
    public partial class Form1 : Form
    {
        ...
        private WordsCollection collection = new WordsCollection();
        ...
        {
            Tovar tv = new Tovar();
            Tovar_adapter tvr = new Tovar_adapter(tv);
            tvr.Add_rand_name();
            tvr.Ser();

        }

        private void Observer_btn_Click(object sender, EventArgs e)
        {
        ...
        private void Add_iterator_btn_Click(object sender, EventArgs e)
        {
            collection.AddItem(iterator_textbox.Text);
        }
    }
}
