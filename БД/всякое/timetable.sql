use master
create database Lab4UniverTimeTable
...
insert into TIMESPACES(ID, STARTTIME, ENDTIME)
values  (1, '8:00', '9:20'), (2, '9:35', '10:55'), (3, '11:10', '12:30'), (4, '12:45', '14:05'),
(5, '14:40', '16:00'), (6, '16:30', '17:50'), (7, '18:05', '19:25');
...
insert into TIMETABLE(IDGROUP,  AUDITORIUM, SUBJECT, TEACHER, [DAY_NAME], [CLASS_NUMBER]) values 
(1, '236-1', 'БД', 'Бракович Андрей Игоревич', 'MONDAY', 1), (2, '206-1', 'БД', 'Звягинцев Вячеслав Борисович', 'SUNDAY', 2), 
(3, '301-1', 'КМС', 'Неверов Александр Васильевич', 'TUESDAY', 3), (4, '206-1', 'БД', 'Звягинцев Вячеслав Борисович', 'TUESDAY', 1), (5, '413-1', 'КГ', 'Акунович Станислав Иванович', 'SUNDAY', 2);
