...
values
    (
        'ЛМиЛЗ',
        'Лесных машин и технологии лесозаготовок',
        'ТТЛП'
    )
insert into
    PULPIT
...
values
    (
        'ТДП',
        'Технологий деревообрабатывающих производств',
        'ТТЛП'
    )
insert into
    PULPIT
...
values
    (
        'ЭТиМ',
        'Экономической теории и маркетинга',
        'ИЭФ'
    )
insert into
    PULPIT
...
values
    (
        'МиЭП',
        'Менеджмента и экономики природопользования',
        'ИЭФ'
    )
insert into
    PULPIT
...
values
    (
        'СБУАиА',
        'Статистики, бухгалтерского учета, анализа и аудита',
        'ИЭФ'
    );
...
values
    (
        'ПЗ',
        'Представление знаний в компьютерных системах',
        'ИСиТ'
    );
...
values
    (
        'ПМАПЛ',
        'Полиграф. машины, автоматы и поточные линии',
        'ПОиСОИ'
    );
...
values
    (
        'ОПП',
        'Организация полиграф. производства',
        'ПОиСОИ'
    );
...
values
    (
        'БЛЗиПсOO',
        'Биология лесных зверей и птиц с осн. охотов.',
        'ОВ'
    )
insert into
    SUBJECT
...
values
    (
        'ОСПиЛПХ',
        'Основы садово-паркового и лесопаркового хозяйства',
        'ЛПиСПС'
    )
insert into
    SUBJECT
...
values
    ...
    -- (
    --     2,
    --     'Никитенко Екатерина Дмитриевна',
    --     '08.01.1994'
    -- ),
    ...
    -- (
    --     4,
    --     'Крученок Евгений Александрович',
    --     '11.05.1992'
    -- ),
    ...
    (
        6,
        'Ходоронок Александра Вадимовна',
        '09.11.1994'
    ),
    (6, 'Рамук Владислав Юрьевич', '04.07.1994'),
    (
        7,
        'Неруганенок Мария Владимировна',
        '03.01.1993'
    ),
    ...
    (
        7,
        'Алексиевич Елизавета Викторовна',
        '09.02.1993'
    ),
...
values
    (
        11,
        'Лавренчук Владислав Николаевич',
        '07.11.1993'
    ),
    ...
    (
        13,
        'Чупрыгин Арсений Александрович',
        '11.11.1994'
    ),
    ...
    (
        14,
        'Ловецкая Валерия Александровна',
        '11.09.1993'
    ),
    ...
    (
        14,
        'Коблинец Александра Евгеньевна',
        '05.01.1993'
    ),
    ...
    (
        18,
        'Щигельская Екатерина Андреевна',
        '06.09.1995'
    ),
    (
        18,
